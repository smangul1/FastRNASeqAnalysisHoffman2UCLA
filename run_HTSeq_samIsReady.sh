...
echo " 	~/anaconda/bin/python /u/home/s/serghei/project/code/import/HTSeq-0.6.1/scripts/htseq-count --mode=intersection-strict --stranded=no  ${1}/${sample}.sam $gtf >${sample}.counts" >>run_${sample}.sh
