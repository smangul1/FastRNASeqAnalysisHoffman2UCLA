...
echo " 	~/anaconda/bin/python /u/home/s/serghei/project/code/import/HTSeq-0.6.1/scripts/htseq-count --mode=intersection-strict --stranded=no  ${sample}_sort_byname.sam $gtf >${sample}.counts" >>run_${sample}.sh

echo "rm -rf ${sample}_sort_byname.sam">>run_${sample}.sh
